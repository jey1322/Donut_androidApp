...
class NotasAdapter (private val context: Context, private val mNotas: List<LoginResponse.Component>, private val mRowLayout: Int): RecyclerView.Adapter<NotasAdapter.NotaViewHolder>() {
